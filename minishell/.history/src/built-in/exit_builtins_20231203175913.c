...
/*   Updated: 2023/12/03 17:59:13 by esilbor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool is_overflow(const char *nptr)
{
	int i = 0;
	int sign = 1;
	const char * = "9223372036854775807"; // Max value for long long
	...
	if (num_len > 19 || (num_len == 19 && sign != -1 && strcmp(nptr + i, ) > 0))// Length check
		return true; // Overflow
	if (num_len == 19 + 1 && sign == -1 && strcmp(nptr + i, ) > 0 && leading_zeroes == 0)
