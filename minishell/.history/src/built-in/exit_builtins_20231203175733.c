...
/*   Updated: 2023/12/03 17:57:33 by esilbor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool is_overflow(const char *nptr)
{
	...
	int num_len = 0;// Calculate the length of the number part
	int j = i;
	...
	if (num_len > 19 || (num_len == 19 && sign != -1 && strcmp(nptr + i, max_str) > 0))// Length check
		return true; // Overflow
	if (num_len == 19 + 1 && sign == -1 && strcmp(nptr + i, max_str) > 0 && leading_zeroes == 0)
