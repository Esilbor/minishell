...
/*   Updated: 2023/12/03 17:55:28 by esilbor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool is_overflow(const char *nptr)
{
	...
	int  = 19; // Length of the max long long value as a string
	...
	// Length check
	if (num_len >  || (num_len ==  && sign != -1 && strcmp(nptr + i, max_str) > 0))
		return true; // Overflow

	if (num_len ==  + 1 && sign == -1 && strcmp(nptr + i, max_str) > 0 && leading_zeroes == 0)
