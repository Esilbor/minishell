...
/*   Updated: 2023/12/03 17:55:40 by esilbor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool is_overflow(const char *nptr)
{
	...
	int 19 = 19; // Length of the max long long value as a string
	...
	// Length check
	if (num_len > 19 || (num_len == 19 && sign != -1 && strcmp(nptr + i, max_str) > 0))
